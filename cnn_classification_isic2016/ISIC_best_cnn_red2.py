...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 23 19:00:36 2018
...
filename = 'isic2016/isic_data_blurred.h5'
...
filepath = 'isic2016/best_cnn1_dense1_b.hdf5'
...
filepath = 'isic2016/best_cnn2_dense1_b.hdf5'
checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1, save_best_only=True)
early_stopping_monitor = EarlyStopping(monitor='val_loss',patience=8)
...
plotHistory(Tuning_cnn_model1, 'cnn1_dense1_b')
plotHistory(Tuning_cnn_model2, 'cnn2_dense1_b')
