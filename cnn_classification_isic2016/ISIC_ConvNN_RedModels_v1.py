...
def GetMetrics(model,predictors,response):
    ...
    print('kappa ', cohen_kappa_score(y_classes, pred_class))
    from sklearn.metrics import confusion_matrix
    print('confusion_matrix\n', confusion_matrix(y_classes, pred_class))
    from sklearn.metrics import roc_auc_score
    print('roc_auc_score ', roc_auc_score(y_classes, pred_class))
...
cnn_model1.add(Conv2D(NUM_KERNELS,kernel_size=(3,3),padding="same",kernel_initializer='glorot_uniform',input_shape = INPUT_SHAPE, data_format='channels_last'))
...
filepath = 'isic2016/cnn_1layer_dense.hdf5'
...
cnn_model2.add(Conv2D(30,kernel_size=(3,3),padding="same",kernel_initializer="glorot_uniform",input_shape=INPUT_SHAPE))
...
cnn_model2.add(Conv2D(40,kernel_size=(5,5),padding="same",kernel_initializer="glorot_uniform"))
cnn_model2.add(Activation("relu"))
cnn_model2.add(MaxPooling2D(pool_size=(2,2)))
cnn_model2.add(BatchNormalization())
...
filepath = 'isic2016/cnn_2layer_dense.hdf5'
checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1, save_best_only=True)
early_stopping_monitor = EarlyStopping(monitor='val_loss',patience=8)
...
cnn_model3.add(Conv2D(30,kernel_size=(3,3),padding="same",kernel_initializer="glorot_uniform",input_shape=INPUT_SHAPE))
...
cnn_model3.add(Conv2D(40,kernel_size=(5,5),padding="same",kernel_initializer="glorot_uniform"))
cnn_model3.add(Activation("relu"))
cnn_model3.add(MaxPooling2D(pool_size=(2,2)))
cnn_model3.add(BatchNormalization())
cnn_model3.add(Dropout(0.3))

cnn_model3.add(Conv2D(64,kernel_size=(7,7),padding="same",kernel_initializer="glorot_uniform"))
cnn_model3.add(Activation("relu"))
cnn_model3.add(MaxPooling2D(pool_size=(2,2)))
cnn_model3.add(BatchNormalization())
...
cnn_model3.add(Dense(NB_CLASSES))
cnn_model3.add(Activation("softmax"))
cnn_model3.compile(loss=LOSS,optimizer=OPTIMIZER,metrics=METRICS)

print(cnn_model3.summary())

filepath = 'isic2016/cnn_3layer_norm.hdf5'
checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1, save_best_only=True)
early_stopping_monitor = EarlyStopping(monitor='val_loss',patience=8)

Tuning_cnn_model3 = cnn_model3.fit(x_train,y_train,batch_size=BATCH_SIZE, epochs=NB_EPOCH, verbose=VERBOSE, validation_split=VALIDATION_SPLIT, callbacks=[checkpoint,early_stopping_monitor])


# Model 4
cnn_model4=Sequential()
cnn_model4.add(Conv2D(30,kernel_size=(3,3),padding="same",kernel_initializer="glorot_uniform",input_shape=INPUT_SHAPE))
cnn_model4.add(Activation("relu"))

cnn_model4.add(Conv2D(40,kernel_size=(5,5),padding="same",kernel_initializer="glorot_uniform"))
cnn_model4.add(Activation("relu"))

cnn_model4.add(Conv2D(64,kernel_size=(7,7),padding="same",kernel_initializer="glorot_uniform"))
cnn_model4.add(Activation("relu"))
cnn_model4.add(MaxPooling2D(pool_size=(2,2)))
cnn_model4.add(BatchNormalization())
cnn_model4.add(Dropout(0.3))

cnn_model4.add(Flatten())
cnn_model4.add(Dense(NB_CLASSES))
cnn_model4.add(Activation("softmax"))
cnn_model4.compile(loss=LOSS,optimizer=OPTIMIZER,metrics=METRICS)

print(cnn_model4.summary())

filepath = 'isic2016/cnn_3layer_nonorm.hdf5'
checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1, save_best_only=True)
early_stopping_monitor = EarlyStopping(monitor='val_loss',patience=8)

Tuning_cnn_model4 = cnn_model4.fit(x_train,y_train,batch_size=BATCH_SIZE, epochs=NB_EPOCH, verbose=VERBOSE, validation_split=VALIDATION_SPLIT, callbacks=[checkpoint,early_stopping_monitor])
...
filepath = 'isic2016/cnn_3layer_norm.hdf5'
finalModel3 = load_model(filepath)
print("Layers in Model 3")
print(finalModel3.layers)
print(" ")

filepath = 'isic2016/cnn_3layer_nonorm.hdf5'
finalModel4 = load_model(filepath)
print("Layers in Model 4")
print(finalModel4.layers)
print(" ")

# Get Accuracy for both models
print("Training Accuracy for 1 CNN and 1 Dense Layer Model:")
print(GetMetrics(cnn_model1,x_train,y_train))
print("Testing Accuracy for 1 CNN and 1 Dense Layer Model:")
print(GetMetrics(cnn_model1,x_test,y_test))
print(" ")

print("Training Accuracy for 2 CNN Layer and 1 Dense Layer Model:")
print(GetMetrics(cnn_model2,x_train,y_train))
print("Testing Accuracy for 2 CNN Layer and 1 Dense Layer Model:")
print(GetMetrics(cnn_model2,x_test,y_test))
print(" ")

print("Training Accuracy for 3 CNN Layer with Norm Model:")
print(GetMetrics(cnn_model3,x_train,y_train))
print("Testing Accuracy for 3 CNN Layer with Norm Model:")
print(GetMetrics(cnn_model3,x_test,y_test))
print(" ")

print("Training Accuracy for 3 CNN Layer wo Norm Model:")
print(GetMetrics(cnn_model4,x_train,y_train))
print("Testing Accuracy for 3 CNN Layer wo Norm Model:")
print(GetMetrics(cnn_model4,x_test,y_test))
print(" ")

# Get Optimization History Plot for both models
plotHistory(Tuning_cnn_model1, 'cnn_1layer_dense')
plotHistory(Tuning_cnn_model2, 'cnn_2layer_dense')
plotHistory(Tuning_cnn_model3, 'cnn_3layer_norm')
plotHistory(Tuning_cnn_model4, 'cnn_3layer_nonorm')
