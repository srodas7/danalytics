...
from Models import Model6, Model6b, GetMetrics, plotHistory

Model6(x_train,y_train,x_test,y_test,'isic2016/bw_cnn6.hdf5',1)
Model6b(x_train,y_train,x_test,y_test,'isic2016/bw_cnn6_lessnorm.hdf5',1)

#Model6(x_train,y_train,x_test,y_test,'isic2016/crop_cnn6.hdf5',3)
#Model6b(x_train,y_train,x_test,y_test,'isic2016/crop_cnn6_lessbn.hdf5',3) 
