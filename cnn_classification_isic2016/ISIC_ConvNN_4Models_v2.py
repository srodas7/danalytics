...
filepath = 'isic2016/best_cnn1layer_1.hdf5'
...
filepath = 'isic2016/best_cnn2layerdense_1.hdf5'
checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1, save_best_only=True)
early_stopping_monitor = EarlyStopping(monitor='val_loss',patience=8)
...
filepath = 'isic2016/best_cnn2layer_1.hdf5'
checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1, save_best_only=True)
early_stopping_monitor = EarlyStopping(monitor='val_loss',patience=8)
...
filepath = 'isic2016/best_cnn1layer2dense.hdf5'
checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1, save_best_only=True)
early_stopping_monitor = EarlyStopping(monitor='val_loss',patience=8)
...
plotHistory(Tuning_cnn_model1, '1cnnD')
plotHistory(Tuning_cnn_model2, '2cnnD')
plotHistory(Tuning_cnn_model3, '2cnn')
