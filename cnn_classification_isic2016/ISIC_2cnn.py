...
from Models import Model2_Tahn, Model2, GetMetrics, plotHistory

#Model2_Tahn(x_train,y_train,x_test,y_test,'isic2016/bw_cnn2_tanh.hdf5',1) 
#Model2(x_train,y_train,x_test,y_test,'isic2016/bw_cnn2_1dense.hdf5',1)

Model2_Tahn(x_train,y_train,x_test,y_test,'isic2016/crop_cnn2_tanh.hdf5',3) 
Model2(x_train,y_train,x_test,y_test,'isic2016/crop_cnn2_1dense.hdf5',3) 
