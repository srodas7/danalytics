...
cnn_model2.add(Conv2D(40,kernel_size=(3,3),padding="same",kernel_initializer="glorot_uniform"))
cnn_model2.add(Activation("relu"))
cnn_model2.add(MaxPooling2D(pool_size=(2,2)))
cnn_model2.add(BatchNormalization())
cnn_model2.add(Dropout(0.3))
...
filepath = 'isic2016/best_model_c2d1.hdf5'
...
plotHistory(Tuning_cnn_model2, 'best_cnn2_dense1')
