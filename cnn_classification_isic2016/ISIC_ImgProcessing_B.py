...
# Read in labels file
#class_label_file = 'Downloads/isic2016/Part3_TrainAug_Labels.csv'
class_label_file = 'isic2016/Part3_TrainAug_CI_Labels2.csv'
...
imagedir = 'isic2016/train_blurred/'
...
# Read in labels file
#class_label_file = 'Downloads/isic2016/Part3_Test_Labels.csv'
...
# Get list of images in augmented train directory
#imagedir = 'Downloads/isic2016/test/'
imagedir = 'isic2016/test_blurred/'
files = listdir(imagedir)
...
#hf = h5py.File("Downloads/isic2016/isic_data.h5", 'w')
hf = h5py.File("isic2016/isic_data_blurred.h5", 'w')
...
# =============================================================================
# # Process Reduced Images into GRAYSCALE vectors with Labels
# x_train = np.empty(shape=(len(files),I.shape[0],I.shape[1],I.shape[2]),dtype=np.int)
# y_train = np.empty(shape=(len(files),), dtype=np.int)
# print(x_train.shape)
# print(y_train.shape)
...
#     I = transform.resize(I,(120, 160)) #Reduce Size
#     x_train[i,:,:,:] = I #files image vectors
#     y_train[i] = train_labels[files[i]] #file label to file image
# 
# =============================================================================
