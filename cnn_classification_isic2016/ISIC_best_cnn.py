...
filename = 'isic2016/isic_data_augci.h5'
...
def plotHistory(Tuning,pltname):
    ...
    plt.savefig('new_opt_history/'+str(pltname)+'.png')
...
# Model 1 - 1 CNN 1 Dense
NUM_KERNELS = 40
cnn_model1 = Sequential()
cnn_model1.add(Conv2D(NUM_KERNELS,kernel_size=(5,5),padding="same",kernel_initializer='glorot_uniform',input_shape = INPUT_SHAPE, data_format='channels_last'))
...
filepath = 'isic2016/best_cnn1_dense1_40k.hdf5'
...
filepath = 'isic2016/best_cnn2_dense2.hdf5'
checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1, save_best_only=True)
early_stopping_monitor = EarlyStopping(monitor='val_loss',patience=8)
...
filepath = 'isic2016/best_cnn3_dense1.hdf5'
checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1, save_best_only=True)
early_stopping_monitor = EarlyStopping(monitor='val_loss',patience=8)
...
filepath = 'isic2016/best_cnn1_dense2.hdf5'
checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1, save_best_only=True)
early_stopping_monitor = EarlyStopping(monitor='val_loss',patience=8)
...
print("Training Accuracy for 2 CNN Layer and Dense Layer Model:")
print(GetMetrics(cnn_model2,x_train,y_train))
print("Testing Accuracy for 2 CNN Layer and Dense Layer Model:")
...
print("Training Accuracy for 1 CNN and 2 Dense Layer Model:")
print(GetMetrics(cnn_model4,x_train,y_train))
print("Testing Accuracy for 1 CNN and 2 Dense Layer Model:")
print(GetMetrics(cnn_model4,x_test,y_test))

# Get Optimization History Plot for both models
plotHistory(Tuning_cnn_model1, '1cnn1D')
plotHistory(Tuning_cnn_model2, '2cnn2D')
plotHistory(Tuning_cnn_model3, '3cnn1D')
plotHistory(Tuning_cnn_model4, '1cnn2D')
