...
filepath = 'isic2016/best_cnn1_dense1.hdf5'
...
filepath = 'isic2016/best_cnn2_dense1.hdf5'
checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1, save_best_only=True)
early_stopping_monitor = EarlyStopping(monitor='val_loss',patience=8)
...
plotHistory(Tuning_cnn_model1, 'cnn1_dense1')
plotHistory(Tuning_cnn_model2, 'cnn2_dense1')
