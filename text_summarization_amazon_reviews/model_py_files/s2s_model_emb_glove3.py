...
filepath='capstone/s2s_emb_glove3.hdf5'
...
decoder_state_input_h = Input(shape=(75,))
decoder_state_input_c = Input(shape=(75,))
...
encoder_model.save('capstone/s2s_emb_encoder_glove3.hdf5')
decoder_model.save('capstone/s2s_emb_decoder_glove3.hdf5')
...
pred_reviews_emb_glove_3 = pd.DataFrame(list(zip(texts_red,summaries_red,predicted_reviews)),columns=['text','summary','predicted'])
pred_reviews_emb_glove_3.to_csv("capstone/pred_reviews_emb_glove_3.csv",sep=',',index=False)
