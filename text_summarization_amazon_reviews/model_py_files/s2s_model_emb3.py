...
filepath='capstone/s2s_emb3.hdf5'
...
encoder_model.save('capstone/s2s_emb_encoder3.hdf5')
decoder_model.save('capstone/s2s_emb_decoder3.hdf5')
...
pred_reviews_emb_3 = pd.DataFrame(list(zip(texts_red,summaries_red,predicted_reviews)),columns=['text','summary','predicted'])
pred_reviews_emb_3.to_csv("capstone/pred_reviews_emb_3.csv",sep=',',index=False)
