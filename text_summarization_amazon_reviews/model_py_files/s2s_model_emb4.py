...
filepath='capstone/s2s_emb4.hdf5'
...
encoder_model.save('capstone/s2s_emb_encoder4.hdf5')
decoder_model.save('capstone/s2s_emb_decoder4.hdf5')
...
pred_reviews_emb_1.to_csv("capstone/pred_reviews_emb_4.csv",sep=',',index=False)
