...
filepath='capstone/s2s_emb1.hdf5'
...
encoder_model.save('capstone/s2s_emb_encoder1.hdf5')
decoder_model.save('capstone/s2s_emb_decoder1.hdf5')
...
pred_reviews_emb_1.to_csv("capstone/pred_reviews_emb_1.csv",sep=',',index=False)
