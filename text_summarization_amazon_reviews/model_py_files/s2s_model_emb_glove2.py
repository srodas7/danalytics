...
filepath='capstone/s2s_emb_glove2.hdf5'
...
encoder_model.save('capstone/s2s_emb_encoder_glove2.hdf5')
decoder_model.save('capstone/s2s_emb_decoder_glove2.hdf5')
...
pred_reviews_emb_glove_2 = pd.DataFrame(list(zip(texts_red,summaries_red,predicted_reviews)),columns=['text','summary','predicted'])
pred_reviews_emb_glove_2.to_csv("capstone/pred_reviews_emb_glove_2.csv",sep=',',index=False)
